<?php
	...
	require_once("../lib/PHPImageWorkshop/Exception/ImageWorkshopBaseException.php");
	require_once("../lib/PHPImageWorkshop/Exception/ImageWorkshopException.php");
	require_once("../lib/PHPImageWorkshop/Core/Exception/ImageWorkshopLayerException.php");
	require_once("../lib/PHPImageWorkshop/Core/ImageWorkshopLib.php");
	require_once("../lib/PHPImageWorkshop/Core/ImageWorkshopLayer.php");
	...
	$result = $db->modifyPortfolio($portfolio_id, $title, $context, $thumbnail_replace_path, $image_replace_path, $category);
	if ($result) {
		$arr  = array(
