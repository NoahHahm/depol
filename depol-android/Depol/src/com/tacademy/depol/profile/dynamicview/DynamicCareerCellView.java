...
public class DynamicCareerCellView extends DynamicCellView<DateInfo> {

	public DynamicCareerCellView(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public DynamicCareerCellView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}
