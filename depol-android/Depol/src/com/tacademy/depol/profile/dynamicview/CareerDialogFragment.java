...
public class CareerDialogFragment extends DynamicDialogFragment {
	...
	public CareerDialogFragment() {
		
	}
	
	public CareerDialogFragment(DateInfo data) {
		mData = data;
	}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View dialogView = inflater.inflate(R.layout.profile_career_dialog_layout, container, false);
		
		startDateView = (TextView)dialogView.findViewById(R.id.career_startDateView);
		endDateView = (TextView)dialogView.findViewById(R.id.career_endDateView);
		mainEditView = (EditText)dialogView.findViewById(R.id.career_mainEdit);
		subEditView = (EditText)dialogView.findViewById(R.id.career_subEdit);
		titleView = (TextView)dialogView.findViewById(R.id.career_titleView);
		
		if (getTag().equals(REQUEST_MODIFY_MODE)) {
			titleView.setText(getString(R.string.career_modify));
		...
		ImageButton btn = (ImageButton)dialogView.findViewById(R.id.career_verify);
		...
		btn = (ImageButton)dialogView.findViewById(R.id.career_cancel);
		btn.setOnClickListener(new OnClickListener() {
